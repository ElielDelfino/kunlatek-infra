...
resource "datadog_monitor" "alta_latencia" {
  ...
  type    = "metric alert"
  message = "Latência da API acima de 200ms por mais de 2 minutos. @eliel.delfino@fanut.ufal.br"
...
resource "datadog_monitor" "taxa_erro" {
  ...
  type    = "metric alert"
  message = "Taxa de erros acima de 1% por mais de 1 minuto. @eliel.delfino@fanut.ufal.br"
...
resource "datadog_monitor" "cpu_alta" {
  ...
  type    = "metric alert"
  message = "CPU dos nodes acima de 80%. @eliel.delfino@fanut.ufal.br"
